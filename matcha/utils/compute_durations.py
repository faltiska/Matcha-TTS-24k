...
Usage:
  python -m matcha.utils.compute_durations -i configs/data/corpus-small-24k.yaml
  python -m matcha.utils.compute_durations -i configs/data/corpus-small-24k.yaml --model facebook/wav2vec2-lv-60-espeak-cv-ft
"""
